...
public class GetHomeAddressHandler implements IntentRequestHandler {

    private static final Logger log = Logger.getLogger(GetHomeAddressHandler.class);

    private UserSetupSpeechletManager userSetupSpeechletManager;

    public GetHomeAddressHandler(UserSetupSpeechletManager userSetupSpeechletManager) {
    ...
    public boolean canHandle(HandlerInput input, IntentRequest intentRequest) {
        return input.matches(Predicates.intentName("GetHomeAddress"));
    }
