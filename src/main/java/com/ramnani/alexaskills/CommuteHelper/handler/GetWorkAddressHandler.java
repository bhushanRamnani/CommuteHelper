...
public class GetWorkAddressHandler implements IntentRequestHandler {

    private static final Logger log = Logger.getLogger(GetWorkAddressHandler.class);

    private UserSetupSpeechletManager userSetupSpeechletManager;

    public GetWorkAddressHandler(UserSetupSpeechletManager userSetupSpeechletManager) {
    ...
    public boolean canHandle(HandlerInput input, IntentRequest intentRequest) {
        return input.matches(Predicates.intentName("GetWorkAddress"));
    }
