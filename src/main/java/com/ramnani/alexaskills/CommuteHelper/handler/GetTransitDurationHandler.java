...
public class GetTransitDurationHandler implements IntentRequestHandler {

    private static final Logger log = Logger.getLogger(GetTransitDurationHandler.class);

    private TransitSpeechletManager transitSpeechletManager;
    private UserSetupSpeechletManager userSetupSpeechletManager;

    public GetTransitDurationHandler(TransitSpeechletManager transitSpeechletManager,
    ...
    public boolean canHandle(HandlerInput input, IntentRequest intentRequest) {
        return input.matches(Predicates.intentName("GetTotalTransitDuration"));
    }
    ...
    public Optional<Response> handle(HandlerInput input, IntentRequest intentRequest) {
        ...
        return transitSpeechletManager.handleGetTotalTransitDurationRequest(input, intentRequest.getIntent());
    }
}
