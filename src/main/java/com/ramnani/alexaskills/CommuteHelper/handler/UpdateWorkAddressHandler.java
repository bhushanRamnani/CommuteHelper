...
public class UpdateWorkAddressHandler implements IntentRequestHandler {

    private static final Logger log = Logger.getLogger(UpdateWorkAddressHandler.class);

    private UserSetupSpeechletManager userSetupSpeechletManager;

    public UpdateWorkAddressHandler(UserSetupSpeechletManager userSetupSpeechletManager) {
    ...
    public boolean canHandle(HandlerInput input, IntentRequest intentRequest) {
        return input.matches(Predicates.intentName("UpdateWorkAddress"));
    }
    ...
    public Optional<Response> handle(HandlerInput input, IntentRequest intentRequest) {
        ...
        return userSetupSpeechletManager.handleUpdateWorkAddressRequest(input);
    }
}
