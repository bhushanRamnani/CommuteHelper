...
public class GetDirectionsHandler implements IntentRequestHandler {

    private static final Logger log = Logger.getLogger(GetDirectionsHandler.class);

    private TransitSpeechletManager transitSpeechletManager;

    public GetDirectionsHandler(TransitSpeechletManager transitSpeechletManager) {
        this.transitSpeechletManager = transitSpeechletManager;
    }

    @Override
    public boolean canHandle(HandlerInput input, IntentRequest intentRequest) {
        return input.matches(Predicates.intentName("GetDirections"));
    }
    ...
    public Optional<Response> handle(HandlerInput input, IntentRequest intentRequest) {
        ...
        return transitSpeechletManager.handleGetDirectionsRequest(input, intentRequest.getIntent());
    }
}
