...
public class RepeatSuggestionHandler implements IntentRequestHandler {

    private static final Logger log = Logger.getLogger(RepeatSuggestionHandler.class);

    private TransitSpeechletManager transitSpeechletManager;

    public RepeatSuggestionHandler(TransitSpeechletManager transitSpeechletManager) {
    ...
    public Optional<Response> handle(HandlerInput input, IntentRequest intentRequest) {
        ...
        return transitSpeechletManager.handleRepeatSuggestionRequest(input, intentRequest.getIntent());
    }
}
