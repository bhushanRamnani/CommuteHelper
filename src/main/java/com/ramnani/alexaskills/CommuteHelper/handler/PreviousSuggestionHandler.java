...
public class PreviousSuggestionHandler implements IntentRequestHandler {

    private static final Logger log = Logger.getLogger(PreviousSuggestionHandler.class);

    private TransitSpeechletManager transitSpeechletManager;

    public PreviousSuggestionHandler(TransitSpeechletManager transitSpeechletManager) {
    ...
    public Optional<Response> handle(HandlerInput input, IntentRequest intentRequest) {
        ...
        return transitSpeechletManager.handlePreviousSuggestionRequest(input, intentRequest.getIntent());
    }
}
